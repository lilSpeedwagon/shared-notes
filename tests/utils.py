...
class AnyRecentDatetime:
    """Matches a datetime that is within specified seconds from now."""
...
class AnyFutureDatetime:
    """Matches a datetime that is in the future within specified range."""
